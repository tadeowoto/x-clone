...
export default function AuthButton({ session }: { session: Session | null }) {
  ...
  return (
    <header className="w-full h-20 bg-slate-950 flex">
      {session === null ? (
        <button
        ...
        <button
          ...
          type="button"
          className="text-white bg-neutral-primary border border-default hover:bg-neutral-secondary-soft hover:text-heading focus:ring-4 focus:ring-neutral-tertiary font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
        >
          Sign out
        </button>
      )}
